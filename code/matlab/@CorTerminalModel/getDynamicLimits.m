function dynamicLimits = getDynamicLimits(self, acId)
    ...
    switch upper(actype)
        ...
        case 'test'
            ...
            dynamicLimits.maxVel_ft_s = 186; % 110 knots
            dynamicLimits.maxTurnRate_deg_s = 7;
            dynamicLimits.maxAltitude_ft = 1200;
            dynamicLimits.maxVertRate_ft_s = 500 / 60;
            dynamicLimits.maxCumTurn_deg = 180;
            dynamicLimits.pitch_deg = 15;
    ...
    idx_speed = find(strcmp(self.mdlFwd1_1.labels_initial, '"speed"'));
    dynamicLimits.maxAccel_ft_s_s = max(diff(self.cutpoints_initial{idx_speed})); % 50 or ~30 knots per second
